"use strict";
/* build-hook-start *//*00001*/try { require('/Users/horuscamachoavila/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20f4eae2d88cdef087541dVwVLUUsKXlxeUVRVAAJaBAYAUgAA', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/horuscamachoavila/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20f4eae2d88cdef087541dVwVLUUsKXlxeUVRVAAJaBAYAUgAA', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
